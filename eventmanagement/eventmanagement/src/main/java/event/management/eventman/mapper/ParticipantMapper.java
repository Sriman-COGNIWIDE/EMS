...
public class ParticipantMapper {
    ...
    public ParticipantDto toDto(Participant participant) {
        ...
        participantDto.setEventId(String.valueOf(participant.getEventId())); // Convert Long to String
    ...
    public Participant toEntity(ParticipantDto participantDto) {
        ...
        participant.setEventId(String.valueOf(Long.valueOf(participantDto.getEventId()))); // Convert String to Long
