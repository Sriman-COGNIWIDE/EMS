...
public class ParticipantServiceImpl implements ParticipantService {
    ...
    public ParticipantDto saveParticipant(ParticipantDto participantDto) {
        Participant participant = new Participant(
                null,
                participantDto.getEventId(), // EventId is now a String
    ...
    @Override
    public void registerUser(String eventId, String employeeId) {
        Participant participant = new Participant();
        participant.setEventId(eventId); // EventId is now a String
    ...
    private ParticipantDto convertToDto(Participant participant) {
        return new ParticipantDto(
                participant.getId(),
                participant.getEventId(), // EventId is now a String
